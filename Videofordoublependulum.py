...
def update(frame):
    ...
    # Update the positions of the masses (as lists)
    mass1.set_data([x1_pos], [y1_pos])  # Use lists to pass data
    mass2.set_data([x2_pos], [y2_pos])  # Use lists to pass data

    return line1, line2, mass1, mass2

# Set up the animation
interval_ms = 10  # 10 ms between frames
...
ani.save('double_pendulum_simulation.gif', writer='ffmpeg', fps=fps)
