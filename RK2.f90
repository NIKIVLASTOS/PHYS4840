program RungeKutta2        ! IN FORTRAN YOU EITHER WRITE 'FUNCTION' OR 'PROGRAM' NV
    implicit none
    real(8) :: t, x, dt, k1, k2, t_end     ! REAL MEANS REAL NUMBERS NV
    integer :: n, i                        ! MEANS TWO INTEGER INPUTS NV
