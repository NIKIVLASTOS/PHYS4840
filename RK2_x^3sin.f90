program RungeKutta4
    ...
    dt = 0.1d0     ! Time step
    t_end_values = [10.0d0, 10000.0d0]  ! Define intervals [0, 10] and [0, 10000]
    ...
    ! Loop over the two t_end values: 10 and 10000
    do j = 1, 2
        t_end = t_end_values(j)
        
        ! Re-initialize t and x for each interval
        t = 0.0d0
        x = 1.0d0
